...
export class DirectoryCreationPanel extends Component<DirectoryCreationPanelProps, DirectoryCreationPanelState> {
    ...
    render = () => {
        ...
        return <div style={{display: 'grid', gap: 20, justifyContent: 'center', justifyItems: 'center', verticalAlign: 'middle', alignItems: 'center', marginTop: 250}}>
            <InputText placeholder={'Введите название папки'} onChange={changeName}/>
            <this.CreateButton onClick={() => {this.props.callback(this.state.name)}}>Создать</this.CreateButton>
        </div>
    }
}